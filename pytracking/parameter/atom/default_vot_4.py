...
def parameters():
    ...
    params.train_skipping = 30                   # How often to run training (every n-th frame)
    ...
    params.box_jitter_pos = 0.2             # How much to jitter the translation for random boxes
    params.box_jitter_sz = 0.3              # How much to jitter the scale for random boxes
